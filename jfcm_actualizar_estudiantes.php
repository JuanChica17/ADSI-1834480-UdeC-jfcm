...
$sentencia = $bd->prepare("UPDATE estudiantes_jfcm SET nombre = ?, apellido = ?, tipo_doc = ?, num_doc = ?, direccion = ?, celular = ?, fecha_nacimiento = ?, genero = ?, zona = ?, estadoc = ?, programaf = ?, tipoie = ?, tiempogb = ?, nivelep = ?, actividadep = ?, tipovi = ?, nivelih = ?, calificacionpm = ?, email = ?, password = ?  WHERE id = ?;");
